...
"""
import meshio
mesh_from_file = meshio.read("meshes/trilayer_air_circle.msh")
...
meshio.write("meshes/facet_trilayer_beam_v2.xdmf", line_mesh)

triangle_mesh = create_mesh(mesh_from_file, "triangle", prune_z=True)
meshio.write("meshes/trilayer_beam_v2.xdmf", triangle_mesh)
